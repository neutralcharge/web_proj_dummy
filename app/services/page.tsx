...
const ServiceCardPreview = ({ title, description, icon }) => {
  return (
    <div className="group transition-all duration-300 hover:z-10">
      <div className="transform transition-all duration-300 
                    group-hover:-translate-y-4 
                    group-hover:shadow-2xl">
        <Card className="overflow-hidden bg-white rounded-2xl h-full 
          ...
          <CardHeader>
            <div className="mb-4 text-blue-600 transition-transform duration-300 
